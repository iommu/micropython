#define MICROPY_HW_BOARD_NAME "VisionSOM RT1052"
#define MICROPY_HW_MCU_NAME   "MIMXRT1052CVL5B"

// VisionCB has 4 user LEDs
#define MICROPY_HW_LED1_PIN (pin_GPIO_AD_B0_06)
#define MICROPY_HW_LED2_PIN (pin_GPIO_AD_B0_08)
#define MICROPY_HW_LED3_PIN (pin_GPIO_AD_B0_09)
#define MICROPY_HW_LED4_PIN (pin_GPIO_AD_B0_10)
...
// LPUART1 on S57/S63                           -> 1
// LPUART2 on D10/D13 and R23/R24 and S65/S67   -> 2
// LPUART3 on S69/S73                           -> 3
// LPUART3 on S166/S152 (Duplicate)             -> 7
// LPUART4 on S140/S129                         -> 4
// LPUART5 on D14/D15 and R03/R05 and S79/S68   -> 5
// LPUART6 on S58/S55                           -> 6
// LPUART8 on S175/S169                         -> 8

#define MICROPY_HW_UART_NUM     (sizeof(uart_index_table) / sizeof(uart_index_table)[0])
#define MICROPY_HW_UART_INDEX   { 0, 1, 2, 3, 4, 5, 6, 7, 8 }
...
#define IOMUX_TABLE_UART \
    ...
    { IOMUXC_GPIO_SD_B0_04_LPUART8_TX }, { IOMUXC_GPIO_SD_B0_05_LPUART8_RX },

// No HW SPI wired to the RPI/ARDUINO connectors, just so the SO-DIMM
// SPI 2 does not exist, SPI3 is mapped to both SPI(1) and SPI (2) at different Pins
#define MICROPY_HW_SPI_INDEX { 1, 2, 3, 4 }
...
// D14/D15  and S72/S78   LPI2C1 ->    0
// S158/S154              LPI2C2 ->    1
// D1/D0 and S69/S83      LPI2C3 ->    2
// S63/S57                LPI2C4 ->    3

#define MICROPY_HW_I2C_INDEX   { 1, 2, 3, 4 }
